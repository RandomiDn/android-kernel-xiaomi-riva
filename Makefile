...
LTO_CFLAGS	:= -flto -flto=jobserver -fipa-pta -fno-fat-lto-objects \
		   -fuse-linker-plugin -fwhole-program -flto-compression-level=19
ifndef CONFIG_INLINE_OPTIMIZATION
...
KBUILD_AFLAGS   += -O3 -mcpu=cortex-a53 -mtune=cortex-a53
KBUILD_LDFLAGS  += -O3 -mcpu=cortex-a53 -mtune=cortex-a53
endif
