...
echo "UPLOAD YOUR SOURCE KERNEL"
git clone --depth=1 -j$(nproc --all) -b riva11-4 https://github.com/RandomiDn/android-kernel-xiaomi-riva --single-branch kernelsource && cd kernelsource
